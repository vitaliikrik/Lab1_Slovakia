...
public class MultithreadingTaskMain {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        System.out.println("It took " + ChronoUnit.MILLIS.between(start, finish)
                + " ms");
        LogByDateThread threadEx = (LogByDateThread) threads.get(0);
        System.out.println("Thread tells it took: " +
                ChronoUnit.MILLIS.between(threadEx.getStartOfFirstThread(),
                        threadEx.getFinishOfLastThread())
                + " ms");
    }
}
